<?php
namespace api\store\parameter\v1_0\xigua\oauth;
...
class OauthResponse extends ApiResponseRedirectParams
{
    ...
    {
        return "https://open-api.ixigua.com/oauth/connect/";
    }
    ...
    public function getRedirectResponseData() : array
    {
        return [
            ...
            'response_type' => 'code',
            'scope'         => 'user_info,xigua.video.create,xigua.video.data',
//             'optionalScope' => '',
            'redirect_uri'  => $this->Router->generateAbsoluteUrl('xigua_code'),
