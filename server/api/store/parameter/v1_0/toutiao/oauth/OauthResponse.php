<?php
namespace api\store\parameter\v1_0\toutiao\oauth;
...
class OauthResponse extends ApiResponseRedirectParams
{
    ...
    {
        return "https://open.snssdk.com/oauth/authorize/";
    }
    ...
    public function getRedirectResponseData() : array
    {
        return [
            ...
            'response_type' => 'code',
            'scope'         => 'user_info,toutiao.video.create,toutiao.video.data',
//             'optionalScope' => '',
            'redirect_uri'  => $this->Router->generateAbsoluteUrl('toutiao_code'),
