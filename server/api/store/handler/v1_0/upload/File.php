 ...
 * @name 文件上传
 * @desc 文件上传。
 * @request api\store\parameter\v1_0\upload\file\FileRequest
 * @response api\store\parameter\v1_0\upload\file\FileResponse
 *
 * @author 李春寅 <licy2013@aliyun.com>
 * @since 2020年3月7日
 */
class File implements ApiClassInterface
{
    /**
     *
     * @var Router $Router
    ...
    public function exec(ApiRequestParamsInterface $Params): ?ApiResponseParamsInterface
    {
        try
        {
            ...
            $this->Db->getManager()->transactional(function()use($Upfile, $absolute_path){
