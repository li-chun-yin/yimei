 ...
 * @since 2018年11月3日
 */
class ImageUpload implements RequestInterface
{
    ...
    {
        return ['image' => new \CURLFile(realpath($this->assign_data['filepath']), $this->assign_data['mime_type'], $this->assign_data['filename'])];
    }
